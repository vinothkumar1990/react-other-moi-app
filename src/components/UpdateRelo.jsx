...
export const UpdateRelo = () => {
  ...
  const API_URL = "https://ievyooeawrzhkemxfswj.supabase.co/rest/v1/mois";
  const API_KEY =
  ...
  const validate = () => {
    ...
    if (!updateProduct.old_amount) temp.old_amount = "பழைய பணம் தேவை";
    else if (isNaN(updateProduct.old_amount)) temp.old_amount = "எண் மட்டும்";

    if (!updateProduct.new_amount) temp.new_amount = "புதிய பணம் தேவை";
    else if (isNaN(updateProduct.new_amount)) temp.new_amount = "எண் மட்டும்";

    if (!updateProduct.given_amount_status)
      temp.given_amount_status = "தடவை தேர்வு செய்யவும்";
    if (!updateProduct.status) temp.status = "நிலை தேர்வு செய்யவும்";
        ...
        >
          ...
          <Button
            ...
            sx={{
              ...
              boxShadow: "0 10px 25px rgba(76,175,80,.4)",
